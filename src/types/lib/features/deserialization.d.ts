 ...
 */
export declare function WithDeSerialization<T extends MixinConstructorHelper>(Base: T): {
    new (...args: any[]): {
    ...
    fromBuffer<TThis extends MixinConstructorHelper>(this: TThis, buffer: Uint8Array): InstanceType<TThis>;
    fromBase64<TThis extends MixinConstructorHelper>(this: TThis, data: string): InstanceType<TThis>;
    fromHex<TThis extends MixinConstructorHelper>(this: TThis, data: string): InstanceType<TThis>;
} & T;
