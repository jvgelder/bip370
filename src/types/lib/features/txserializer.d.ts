...
export declare function WithTxSerialization<T extends MixinConstructorHelper>(Base: T): {
    new (...args: any[]): {
        /**
         ...
         */
        extractTransactionBytes(this: InstanceType<T> & PsbtV2Base, allowIncomplete?: boolean): Uint8Array;
