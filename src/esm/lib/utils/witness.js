 ...
 */
export function serializeWitnessUtxo(script, value) {
 ...
 */
export function deserializeWitnessUtxo(data) {
 ...
 */
export function serializeWitnessStack(stack) {
 ...
 */
export function deserializeWitnessStack(data) {
  const stack = [];
  let offset = 0;
