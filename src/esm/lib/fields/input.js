...
export const InputField = {
  ...
  [InputTypes.OUTPUT_INDEX]: {
    ...
    encode: index => ({ value: writeUInt32LE(index) }),
  ...
  [InputTypes.SEQUENCE]: {
    ...
    encode: seq => ({ value: writeUInt32LE(seq) }),
  ...
  [InputTypes.REQUIRED_TIME_LOCKTIME]: {
    ...
    encode: time => ({ value: writeUInt32LE(time) }),
  ...
  [InputTypes.REQUIRED_HEIGHT_LOCKTIME]: {
    ...
    encode: height => ({ value: writeUInt32LE(height) }),
  ...
  [InputTypes.PARTIAL_SIG]: {
    ...
    encodeKey: keyData => keyFromType(InputTypes.PARTIAL_SIG, keyData),
  ...
  [InputTypes.SIGHASH_TYPE]: {
    ...
    encode: sigHash => ({ value: writeUInt32LE(sigHash) }),
  ...
  [InputTypes.BIP32_DERIVATION]: {
    ...
    encodeKey: keyData => keyFromType(InputTypes.BIP32_DERIVATION, keyData),
    decode: (value, keyData) => {
  ...
  [InputTypes.TAP_SCRIPT_SIG]: {
    ...
    encodeKey: keyData => keyFromType(InputTypes.TAP_SCRIPT_SIG, keyData),
    decode: (value, keyData) => {
  ...
  [InputTypes.FINAL_SCRIPTWITNESS]: {
    ...
    encode: stack => ({ value: serializeWitnessStack(stack) }),
