...
export class Extractor extends Finalizer {
  // Provided by WithTxSerialization in the builder composition chain
  declare extractTransactionBytes: (allowIncomplete?: boolean) => Uint8Array;
  declare extractTransactionHex: (allowIncomplete?: boolean) => string;
